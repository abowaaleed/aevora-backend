...
const List<PlanInfo> planCatalog = [
  PlanInfo(
    ...
    features: [
      ...
      'النطق الاحترافي (صوت إيدج) مجاناً وبلا حدود',
      'رفع حتى 5 مستندات',
      'ملفات حتى 50 م.ب — ومساحة تخزين 50 م.ب',
      'المزامنة عند تسجيل الدخول',
      'تحويل تلقائي إلى Groq عند تعذّر Gemini',
    ],
  ),
  PlanInfo(
    ...
    features: [
      'كل مزايا المجانية',
      'النطق الاحترافي المتقدم من Gemini بلا حدود',
      'رفع حتى 300 مستند',
...
/// خطة «مجانية»: عدد محدود من المستندات ومساحة إجمالية معقولة للمتصفح والجوال.
/// حد الحجم للملف الواحد يساوي سقف المزامنة (50 م.ب) حتى تُرفع الملفات
/// الممسوحة الكبيرة، بينما يبقى إجمالي التخزين محدوداً بـ 50 م.ب.
