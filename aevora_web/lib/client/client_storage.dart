...
/// طبقة التخزين المحلية (IndexedDB) — كل بيانات المستخدم تبقى على جهازه.
/// لا تُرسل أي ملفات أو ذكريات أو محادثات إلى أي خادم.
class LocalDb {
...
/// حمّالة بايتات + اسم ملف، معاً في كائن واحد.
